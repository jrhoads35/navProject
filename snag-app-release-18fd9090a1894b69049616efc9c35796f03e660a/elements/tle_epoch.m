function dttm = tle_epoch(line1)
  year = 2000 + sscanf(cell2mat(extractBetween(line1,19,20)),'%d');
  doy = sscanf(cell2mat(extractBetween(line1,21,32)),'%f');
  dttm = datetime(year,1,1) + days(doy-1);
end
